        ...
        <div className="space-y-4">
          {issues.length === 0 ? (
            ...
            >
              ...
              <p className="text-gray-600 mb-4">Report your first maintenance issue to get started</p>
              <button
                onClick={() => setShowReportModal(true)}
            ...
            <div className="p-6">
              ...
              {classification && (
                <div className="mb-6 p-4 bg-blue-50 rounded-lg">
                  <h3 className="font-semibold text-blue-900 mb-2">AI Classification Result</h3>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="font-medium">Category:</span>
                      <span className="ml-2 text-blue-700">{classification.category}</span>
                    </div>
                    <div>
                      <span className="font-medium">Confidence:</span>
                      <span className="ml-2 text-blue-700">{(classification.confidence * 100).toFixed(1)}%</span>
                    </div>
                    <div>
                      <span className="font-medium">Priority:</span>
                      <span className="ml-2 text-blue-700">{classification.classification.priority}</span>
                    </div>
                    <div>
                      <span className="font-medium">Assigned To:</span>
                      <span className="ml-2 text-blue-700">{classification.contractor}</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="flex justify-end space-x-4">
                ...
                <button
                  ...
                  className={`btn-primary ${(!selectedImage || classifying) ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
                  {classifying ? (
                    <div className="flex items-center">
